...
import bf1sbp3clear from '../img/pg3.png'
...
export default function BF1U1P1Match2(props) {
        ...
        <div>
            ...
            <div className="split-content">
                ...
                <div className="right-content-pane" ref={drop} >
                    ...
                    <ItemDrag id="drag1" canvasRef = {canvasRefA} left="600" top="200">
                        <div className="ringDiv">
                            <img className="matchRing" src={paper} />
                        </div>
                    </ItemDrag>
                    <ItemDrag id="drag2" canvasRef = {canvasRefB} left="0" top="550">
                        <div className="ringDiv">
                            <img className="matchRing" src={shelf} />
                        </div>
                    </ItemDrag>
                    <ItemDrag id="drag3" canvasRef = {canvasRefC} left="150" top="550">
                        <div className="ringDiv">
                            <img className="matchRing" src={crayon} />
                        </div>
                    </ItemDrag>
                            
                    <img src={bf1sbp3clear} style={{position:'absolute', left:'0px', top:'50px'}} />
                </div>

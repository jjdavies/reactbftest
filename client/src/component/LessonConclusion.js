...
export default function LessonObjectives(props) {
    ...
    return (
        <div>
            <div className="unit-period-heading">Lesson Conclusion</div>
            <div className="unit-name-heading">I have:</div>
            ...
            <CustomButton buttonText="home" onClick={nextStage} left='1000' top='630'/>
        </div>
    )
}
